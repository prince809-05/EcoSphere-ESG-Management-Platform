...
async function main() {
  ...
  await prisma.feedback.createMany({
    data: [
      ...
      { userId: emp1.id, category: 'GENERAL', subject: 'Dashboard makes ESG easy to understand', message: 'The main dashboard gives a clear snapshot of environmental, social, and governance performance without needing to open multiple reports.', rating: 5, status: 'REVIEWED', adminNote: 'Thank you! We designed the dashboard for quick executive review.' },
      { userId: emp2.id, category: 'GENERAL', subject: 'Helpful carbon tracking workflow', message: 'Logging carbon transactions with emission factors is simple and helps our team understand what creates the biggest footprint.', rating: 5, status: 'REVIEWED', adminNote: 'Glad the workflow is helping the team.' },
      { userId: emp3.id, category: 'GENERAL', subject: 'Governance module is useful', message: 'The audit and compliance issue tracking makes it easier to know what needs attention and who owns each action.', rating: 4, status: 'REVIEWED' },
      { userId: emp5.id, category: 'FEATURE_REQUEST', subject: 'Public feedback section is a good idea', message: 'It would be nice if positive general feedback and useful feature ideas were visible to everyone for transparency.', rating: 5, status: 'RESOLVED', adminNote: 'Implemented public visibility for positive general and feature feedback.' },
      { userId: emp6.id, category: 'FEATURE_REQUEST', subject: 'Add more chatbot guidance', message: 'The ESG assistant should suggest what to improve next based on policies, audits, CSR participation, and carbon logs.', rating: 5, status: 'REVIEWED' },
      { userId: mfgManager.id, category: 'GENERAL', subject: 'Great for hackathon demo flow', message: 'The platform connects ESG scores with real actions like CSR approvals, compliance issues, audits, and emission logs.', rating: 5, status: 'REVIEWED' },
      { userId: logManager.id, category: 'GENERAL', subject: 'Logistics team likes the fleet insights', message: 'The fleet emission tracking helps us discuss route optimization and diesel reduction with better context.', rating: 4, status: 'REVIEWED' },
    ]
  });
